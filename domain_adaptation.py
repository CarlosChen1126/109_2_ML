# -*- coding: utf-8 -*-
"""hw11_domain_adaptation good.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1JIY5pdMFv1TY6ApRxdVuWNweZP9NlvoG
...
def train_epoch(source_dataloader, target_dataloader, lamb):
    ...
    scheduler_F = get_cosine_schedule_with_warmup(optimizer_F, num_warmup_steps = len(source_dataloader)/20, num_training_steps =len(source_dataloader), num_cycles=2)
    scheduler_C = get_cosine_schedule_with_warmup(optimizer_C, num_warmup_steps = len(source_dataloader)/20, num_training_steps =len(source_dataloader), num_cycles=2)
    scheduler_D = get_cosine_schedule_with_warmup(optimizer_D, num_warmup_steps = len(source_dataloader)/20, num_training_steps =len(source_dataloader), num_cycles=2)
    ...
    for i, ((source_data, source_label), (target_data, _)) in enumerate(zip(source_dataloader, target_dataloader)):
        ...
        loss = class_criterion(class_logits, source_label) - 2*lamb * domain_criterion(domain_logits, domain_label)
...
for epoch in range(6000):
    ...
    gamma = -10
    p = epoch/6000
    lamb_p = ( 2 / ( 1 + math.exp(gamma * p))) - 1
    train_D_loss, train_F_loss, train_acc = train_epoch(source_dataloader, target_dataloader, lamb=lamb_p)
...
df.to_csv('DaNN_submission__555.csv',index=False)

from google.colab import files
files.download('DaNN_submission__55.csv')
