...
class COVID19Dataset(Dataset):
    ...
    def __init__(self,
        ...
        if not target_only:
            ...
            # TODO: Using  states & 2 tested_positive features (indices = 57 & 75)
            #feats = [41,43,45,46,47,52,53,55,57,59,61,63,64,65,70,71,73,75,77,79,81,82,83,88,89,91]
            #feats =[41,43,57,59,61,75,77,79]
...
class NeuralNet(nn.Module):
    ...
    def cal_loss(self, pred, target):
        ...
        #for param in model.parameters():
          #l2_reg+=(torch.norm(param)*torch.norm(param))
        #loss=l2_lamb*l2_reg+self.criterion(pred, target)
